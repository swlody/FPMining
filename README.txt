USAGE:
python3 apriori.py [-h] [--min_sup [MIN_SUP]] [filename]

For example, for the adult.data dataset from http://archive.ics.uci.edu/ml/datasets/Adult:
python3 apriori.py adult.data --min_sup 0.3 --labels age workclass fnlwgt education education-num marital-status occupation relationship race sex capital-gain capital-loss hours-per-week native-country
